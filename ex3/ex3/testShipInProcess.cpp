...
int testShipInProcess::testmegreShipsInProcess()
{
	...
	ShipInProcess sizeFive_5(4, 3, 2);
	sizeFive_5.addCoordinate(4, 4, 2);
	sizeFive_5.addCoordinate(4, 5, 2);
	sizeFive_5.addCoordinate(4, 2, 2);
	sizeFive_5.addCoordinate(4, 1, 2);

	sizeThree_1.megreShipsInProcess(sizeTwo_2);
	if (!sizeThree_1.compareShipsFields(false, true, false, Coordinate(4, -1, 2), Coordinate(4, 3, 2), createVector(1, 2, 3, 4, 5), 5)) {
	...
	//one to many
	ShipInProcess originShip1(2, 2, 5);
	ShipInProcess secondShip1(2, 2, 2);
	secondShip1.addCoordinate(2, 2, 3);
	secondShip1.addCoordinate(2, 2, 4);

	originShip1.megreShipsInProcess(secondShip1);
	if (!originShip1.compareShipsFields(false, false, true, Coordinate(2, 2, -1), Coordinate(2, 2, 5), createVector(2, 3, 4, 5), 4)) {
		std::cout << "ships coors should have been : <2,2,2> <2,2,3> <2,2,4> <2,2,5> 2" << std::endl;
	}


	//many to many
	ShipInProcess originShip2(2, 2, 2);
	originShip2.addCoordinate(2, 2, 3);
	originShip2.addCoordinate(2, 2, 4);

	ShipInProcess secondShip2(2, 2, 5);
	secondShip2.addCoordinate(2, 2, 6);
	secondShip2.addCoordinate(2, 2, 7);

	originShip2.megreShipsInProcess(secondShip2);
	if (!originShip2.compareShipsFields(false, false, true, Coordinate(2, 2, -1), Coordinate(2, 2, 2), createVector(2, 3, 4, 5, 6, 7), 6)) {
		std::cout << "ships coors should have been : <2,2,2> <2,2,3> <2,2,4> <2,2,5> <2,2,5> <2,2,6> <2,2,7> 3" << std::endl;
	}


	//one to one
	ShipInProcess originShip3(2, 2, 6);
	ShipInProcess secondShip3(2, 2, 7);

	originShip3.megreShipsInProcess(secondShip3);
	if (!originShip3.compareShipsFields(false, false, true, Coordinate(2, 2, -1), Coordinate(2, 2, 6), createVector(6, 7), 2)) {
